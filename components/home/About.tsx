  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start w-full">
        <h2 className="event-header text-3xl font-primary mt-20 mb-6 md:text-4xl sm:text-4xl font-normal tracking-widest uppercase">
          About Us
        </h2>
        
        <div className="flex flex-col gap-8 w-full">
          <p className="text-base md:text-lg lg:text-lg font-secondary text-white/80 leading-[1.8] about-text ">
