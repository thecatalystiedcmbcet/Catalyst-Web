...
const WatermarkHeader: React.FC<WatermarkHeaderProps> = ({
  ...
  return (
    <div className="relative w-full flex items-center justify-center py-12 md:py-20 lg:py-24">
      ...
      {/* Header */}
      <h2
        className={`relative z-10 text-[6vw] md:text-[48px] lg:text-[62px] font-primary font-normal text-white uppercase text-center leading-none tracking-normal ${titleClassName}`}
      >
        {title}
      </h2>
    </div>
